...
const CLASSES = {
  ...
  SECTION_DIVIDER:
    "border-r md:border-l md:border-[#454545] mx-auto 2xl:max-w-[74%] md:max-w-[calc(100%-240px)] w-full pt-[100px]",
...
export const GridBox = ({
  ...
  const getContinuousGroups = () => {
    ...
    let currentGroup: { start: number; end: number; isDark: boolean } | null =
      null;
  ...
  const getSectionStyles = (index: number) => {
    ...
    return {
      bgColor: dark ? CLASSES.DARK_SECTION : "",
      borderColor: dark ? CLASSES.DARK_BORDER : CLASSES.LIGHT_BORDER,
        ...
        return (
          ...
          >
            ...
            <div className={CLASSES.CONTENT_WRAPPER}>
              <div
                className={`${CLASSES.INNER_WRAPPER} ${styles.borderColor} ${classNameParent}`}
              >
                <div
                  className={`inner-content ${styles.childClassName} ${styles.textColor}`}
                >
                  {child}
                </div>
              </div>
