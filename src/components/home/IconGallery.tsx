    ...
    return (
        <div ref={galleryRef} className="w-[100%] flex md:flex-row flex-col">
            <div className="w-[100%] flex justify-center items-center md:w-[50%] h-[600px] border-r border-[#ececec] px-[16px] md:px-[56px] py-[32px] md:py-[64px]" >
                <Image src="/IconGallery.svg" alt="Icon Gallery" width={1000} height={1000} className={`w-[456px] h-[504px] pointer-events-none transition-all duration-600 ease-out ${
                    isVisible ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 translate-y-4'
                }`} />
            </div>
            <div className="relative w-[100%] md:w-[50%] flex flex-col gap-[56px] px-[16px] md:px-[56px] py-[32px] md:py-[64px]">
                <p className={`text-[#0e0e0e] font-bold text-[16px] leading-[24px] transition-all duration-600 ease-out ${
                ...
                <div className={`flex gap-[8px] transition-all duration-600 ease-out ${
                    isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
                ...
                <div className={`relative md:absolute -bottom-[80px] md:-bottom-[10%] 2xl:right-[15%] -right-[50%] md:-right-[5%] translate-x-[-50%] flex flex-col justify-center items-center transition-all duration-600 ease-out ${
                    isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
